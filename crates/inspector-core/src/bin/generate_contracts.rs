...
export interface DatabaseResultAvailability { readonly availability: DatabaseCaptureAvailability; readonly reason: string | null; readonly columns: readonly string[]; readonly rows: readonly (readonly JsonValue[])[]; readonly rowsObserved: number | null; readonly rowsCaptured: number | null; readonly truncated: boolean; }
